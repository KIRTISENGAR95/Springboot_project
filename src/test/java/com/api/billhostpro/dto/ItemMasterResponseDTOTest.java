...
class ItemMasterResponseDTOTest {
    ...
    void gettersAndSettersShouldWork() {
        ...
        ItemMasterResponseDTO dto = createResponseDTO(id);
    ...
    void equalsAndHashCodeShouldUseFieldValues() {
        UUID id = UUID.randomUUID();
        ItemMasterResponseDTO firstDTO = createResponseDTO(id);
        ItemMasterResponseDTO secondDTO = createResponseDTO(id);
        ItemMasterResponseDTO differentDTO = createResponseDTO(UUID.randomUUID());
    ...
    private ItemMasterResponseDTO createResponseDTO(UUID id) {
        ItemMasterResponseDTO dto = new ItemMasterResponseDTO();
        dto.setId(id);
